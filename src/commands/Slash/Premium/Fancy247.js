...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (data) {
            ...
            const off = new EmbedBuilder().setDescription(`<a:off_off:1147902531792556124> | 247 Mode has been: \`Disabled\``).setColor(client.color);
            ...
            const on = new EmbedBuilder().setDescription(`<a:on2:1147902444953681980> | 247 Mode has been: \`Enabled\``).setColor(client.color);
