    ...
    run: async (client, message) => {
        ...
        cpuStat.usagePercent(function (err, percent, seconds) {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields([
                    { name: "\<a:bot:1147805116297125959> | Client", value: `\`\`\`Servers: ${scount}\nChannels: ${ccount}\nUsers: ${mcount}\`\`\``, inline: false },
                    {
                        name: "<a:cpu:1147886961005170818> | CPU",
                    ...
                    {
                        name: "<a:server:1147887344905625650> | RAM",
                    ...
                    {
                        name: "<a:discord:1147888069203210310> | Discord",
                        value: `\`\`\`Discord.js: v${version}\nNode: ${process.version}\nAPI Websocket Ping: ${Math.round(
                            client.ws.ping
                        )}ms\`\`\``,
                        inline: false,
                    },
                    { name: "<:System:1147887912998944928> | System", value: `\`\`\`Uptime: ${dDisplay + hDisplay + mDisplay + sDisplay}\`\`\``, inline: true },
                ])
